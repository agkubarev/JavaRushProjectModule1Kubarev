...
async def send_image(update: Update, context: ContextTypes.DEFAULT_TYPE,
                     name: str) -> Message:
    with open(f'D:/learn Python/JavaRushProject1_Kubarev/resources/images/{name}.jpg', 'rb') as image:
...
def load_message(name):
    with open("D:/learn Python/JavaRushProject1_Kubarev/resources/messages/" + name + ".txt", "r",
...
# загружает промт из папки /resources/prompts/
def load_prompt(name):
    with open("D:/learn Python/JavaRushProject1_Kubarev/resources/prompts/" + name + ".txt", "r",
              encoding="utf8") as file:
        return file.read()
